...
<body>
    ...
    <%
         ...
         else
         {
			...
			try
			{
                ...
                rs = st.executeQuery("select * from regusers;");
                int i = 1;
                %>
    ...
    <a href="/udbhav/jsp/ShowFeedback.jsp" style="float:right; color:rgb(10, 200, 30); font-size: 25px; margin-right:20px; margin-top: 10px;">User's Feedback</a>
    <br><br>
    <div class="div-main">
        ...
        <div class="div-title">
            <table border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td valign="middle">Registered Customers</td>
        ...
        while(rs.next())
        {
            %>
                <tr>
                    ...
                    <td><a href='tel:<%=rs.getString("mob")%>'><img src="/udbhav/images/call-icon-cust.jpg"
                                alt="Make a call"></a></td>
                    <td><a href="#"><img src="/udbhav/images/notes-icon-cust.png" alt="Make a note"></a></td>

                    <%
String uid=rs.getString("userid");
%>

                    <td><a href="javascript:showProfile('<%=uid%>')"><img src="/udbhav/images/profile-icon-cust.png"
                                alt="View Profile"></a></td>
                </tr>
                <%
                    i += 1;
                }
        ...
        <div id="div-profile" class="div-profile">
